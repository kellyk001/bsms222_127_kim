---
title: "Ch8-Visualizing data distributions"
output:
  html_document:
    df_print: paged
---
...
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic1.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic2.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic3.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic4.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic5.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic6.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic7.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic8.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic9.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic10.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic11.png"))
```
...
_**b. The graph above shows only four numbers with a bar plot.**_
c. Categories are not numbers, so it does not make d. sense to graph the distribution.
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic12.png"))
```
...
_**d. With the exception of 4 states, the murder rates are below 5 per 100,000.**_

7. Below is a histogram of male heights in our heights dataset:

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic13.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic14.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic15.png"))
```
...
_**d. They are the same dataset, but the first is not in the log scale, the second undersmooths, and the third oversmooths.**_
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic16.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic17.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic18.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic19.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic20.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic21.png"))
```
...
male_percentiles <- qnorm(p, mean = mean(male), sd = sd(male))

female_percentiles <- qnorm(p, mean = mean(female), sd = sd(female))

library(pander)
tibble(female_percentiles, male_percentiles) %>% pander()
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic22.png"))
```
...
#About 33% of males are between 69 and 72 inches.
```
...
```{r}
pnorm(72, mean = mean(male), sd = sd(male)) -
pnorm(69, mean = mean(male), sd = sd(male))
```
...
approx <- pnorm(81, mean = mean(male), sd = sd(male)) - pnorm(79, mean = mean(male), sd = sd(male))
...
```{r}
10^9 * (1 - pnorm(84, mean = 69, sd = 3))

#About 287 men would be 7 feet or taller
```
...
```{r}
10/{10^9 * (1 - pnorm(84, mean = 69, sd = 3))}
```
...
150/{10^9 * (1 - pnorm(80, mean = 69, sd = 3))}
```
...
_**c. As seen in question 10, the normal approximation tends to underestimate the extreme values. It’s possible that there are more seven footers than we predicted.**_
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch8-pic23.png"))
```
