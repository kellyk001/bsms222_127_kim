---
title: "Ch10-Data-visualization-principles"
output:
  html_document:
    df_print: paged
---
...
If for some reason you need to make a pie chart, label each pie slice with its respective percentage so viewers do not have to infer them from the angles or area:(pi chart)
...
This plot makes a 13% increase look like a five fold change. Here is the appropriate plot:(bar chart)
...
Here is the appropriate plot:(bar chart)
...
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic1.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic2.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic3.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic4.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic5.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic6.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic7.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic9.png"))
```
...
The combination of an incorrectly chosen barplot and a failure to use a log transformation when one is merited can be particularly distorting. As an example, consider this barplot showing the average population sizes for each continent in 2015:(bar chart)
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic10.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic11.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic12.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic13.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic14.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic15.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic16.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic17.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic18.png"))
```
...
_**d. Never. Barplots and tables are always better.**_


2. What is the problem with the plot below:

```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic19.png"))
```

a. The values are wrong. The final vote was 306 to 232.

_**b. The axis does not start at 0. Judging by the length, it appears Trump received 3 times as many votes when, in fact, it was about 30% more.**_
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic20.png"))
```
...
_**c. The plot on the right is better because alphabetical order has nothing to do with the disease and by ordering according to actual rate, we quickly see the states with most and least rates.**_
...
```{r}
dat %>% mutate(rate = count / population*10000*52 / weeks_reporting) %>% mutate(state = reorder(state, rate, FUN = mean)) %>% ggplot(aes(rate, state)) +
  geom_bar(stat="identity")
```
...
_**c. It does not show all the data. We do not see the variability within a region and it’s possible that the safest states are not in the West.**_
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic21.png"))
```
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch10-pic22.png"))
```

Why is this happening?


_**a. Humans are not good at reading pseudo-3D plots.**_
...
```{r}
#Let's include the US average.
avg <- us_contagious_diseases %>%
  filter(disease==the_disease) %>% group_by(year) %>%
  summarize(us_rate = sum(count, na.rm = TRUE) / 
              sum(population, na.rm = TRUE) * 10000)

#Create time series plot for smallpox.
dat %>% 
  filter(!is.na(rate)) %>%
    ggplot() +
  geom_line(aes(year, rate, group = state),  color = "grey50", 
...
```{r}
#Data for California, with all the diseases included.
dat <- us_contagious_diseases %>%
  filter(state == "California" & weeks_reporting >= 10) %>%
  mutate(rate = count / population * 10000 * 52 / weeks_reporting)

#Create time series plot for all diseases in California.

dat %>% filter(!is.na(rate)) %>%
    ggplot() +
  geom_line(aes(year, rate, group = disease, color = disease),  
            show.legend = TRUE, alpha = 1, size = 1) +
  scale_color_brewer(palette = "Set2") +
  scale_y_continuous(trans = "sqrt", breaks = c(5, 25, 125, 300)) + 
  ggtitle("Cases in California") + 
  xlab("") + ylab("")
```
