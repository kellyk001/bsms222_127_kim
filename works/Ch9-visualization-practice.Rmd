---
title: "Ch9-Visualization-practice"
output:
  html_document:
    df_print: paged
---
...
gapminder %>% 
  ...
  select(country, infant_mortality) %>% pander()
...
In base 10, this turns into a range that includes very few integers: just 0 and 1. With base two, our range includes -2, -1, 0, 1, 2, 3, 4, and 5. It is easier to compute  $2^x$ and
$10^x$ when  x  is an integer and between -10 and 10, so we prefer to have smaller integers in the scale. Another consequence of a limited range is that choosing the binwidth is more challenging. With log base 2, we know that a binwidth of 1 will translate to a bin with range  x  to  2x .
...
filter(gapminder, year == past_year) %>%
  summarize(min = min(population), max = max(population)) %>% pander()
#>     min      max
#> 1 46075 8.09e+08
```
...
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/Ch9-pic1.png"))
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch9-pic2.png"))
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch9-pic3.png"))
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch9-pic4.png"))
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch9-pic5.png"))
...
```{r echo=FALSE, out.width = '100%'}
knitr::include_graphics(rep("C:/Users/MinSeo Kim/Documents/R/ch9-pic6.png"))
